...
struct LweSamplelvl2 {
	Torus64* a; //-- the n coefs of the mask
    Torus64 b;  //
   	double current_variance; //-- average noise of the sample

#ifdef __cplusplus
   LweSamplelvl2(const LweParams* params);
   ~LweSamplelvl2();
   LweSamplelvl2(const LweSamplelvl2&)=delete;
   LweSamplelvl2& operator=(const LweSamplelvl2&)=delete;
#endif
};
...
EXPORT void delete_LweSamplelvl2(LweSamplelvl2* obj);
